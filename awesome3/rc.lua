...
tags[0] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, layouts[1])
--end
-- }}}
...
--    awful.key({modkey,            }, "KP_Left", function() awful.util.spawn("mpc prev") end),
    ...
    awful.key({modkey, "Shift"    }, "f", function() awful.util.spawn("firefox -P Majerti -no-remote") end),
    awful.key({modkey, "Shift"    }, "v", function() awful.util.spawn("firefox -P Tech -no-remote") end),
    awful.key({modkey, "Shift"    }, "g", function() awful.util.spawn("firefox -P Facebook -no-remote") end),
